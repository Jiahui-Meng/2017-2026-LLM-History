...
本次审计覆盖新的时间线主页、`docs/llm_timeline.md`、家族历史页、专题页、`data/timeline.yaml`、`data/families.yaml`、`data/claims.yaml`、`data/models.yaml` 与新的时间线表格/图表。
...
- `data/claims.yaml` 的每条 claim 均包含 `improvement`、`innovation`、`impact` 三项历史叙事字段。
